            ...
            <div class="tab-type3">
                ...
                <div class="board-common_header">
                  ...
                  <div class="board_style">
                    <div class="style1"><input type="radio" name="style" id="style1"><label for="style1">한줄로 보기</label></div>
                    <div class="style2"><input type="radio" name="style" id="style2" checked><label for="style2">두줄로 보기</label></div>
                  </div>
                </div>
                
                <div class="tab-content">
                  <div v-show="currentTab == 0">
                    <ul class="club-list more-type">
