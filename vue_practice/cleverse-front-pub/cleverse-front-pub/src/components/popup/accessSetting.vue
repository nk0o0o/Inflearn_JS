            ...
            <div class="half">
              <ul class="list">
                ...
                <li>
                  ...
                  <div>
                    <div class="input-chk square">
                      <input type="checkbox" name="chk1" id="chk2-all"><label for="chk2-all"></label>
                    </div>
                  </div>
                </li>
                <li>
                  ...
                  <div>
                    <div class="input-chk square">
                      <input type="checkbox" name="chk1" id="chk3-all"><label for="chk3-all"></label>
                    </div>
                  </div>
                </li>
              </ul>
