              ...
              <div>
                ...
                <div class="board-write-search flex col">
                  ...
                  <div class="flex">
                    ...
                    <div class="input-chk square mg-l15">
                      <input type="checkbox" name="chk" id="chk1-1"><label for="chk1-1">전사</label>
                    </div>
                  </div>
                </div>
                <!-- //search -->
              ...
              <div class="full"> 
                <div class="title sub">
                  ...
                  <!-- <div class="input-chk square">
                    <input type="checkbox" name="chk3" id="chk3-00"><label for="chk3-00">담당자</label>
                  </div> -->
                </div>
                <ul class="list">
