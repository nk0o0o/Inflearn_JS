    ...
    <template v-slot:body>
      <div class="designation-wrap">
        ...
        <div class="cnt-org type2">
          ...
          <!-- //search -->
          <div class="board-write-tree-form single">
        ...
        <div class="cnt-right type2">
          <div class="cnt-refer">
            <div>
              <ul class="list">
                <li><div class="input-chk square"><input type="checkbox" name="chk2" id="chk2-1"><label for="chk2-1">선택대상</label></div></li>
                <li>
                  <div class="input-chk square"><input type="checkbox" name="chk2" id="chk2-2"><label for="chk2-2">재무실</label></div>
                  <div class="input-chk square"><input type="checkbox" name="chk2" id="chk2-3"><label for="chk2-3">하위부서포함</label></div>
                </li>
                 <li>
                  <div class="input-chk square"><input type="checkbox" name="chk2" id="chk2-4"><label for="chk2-4">김한화 전무부장</label></div>
                </li>
              </ul>
            </div>
          </div>
