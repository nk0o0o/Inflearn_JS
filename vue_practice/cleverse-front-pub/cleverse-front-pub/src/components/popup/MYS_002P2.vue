<template>
  <base-popup 
    ...
    @confirm="onConfirm" 
    title="주요 업무 이력"
    class="ly-pop-type1 admin lg f-14"
  >
    <template v-slot:body>
      <div class="mytask-list_regist flex jc-sb">
        <div class="flex">
          <div class="date line-type h40">
            <Datepicker 
              weekStart="0"
              v-model="rangeDate"
              range 
          ...
          <div class="input-chk type2 mg-l20"><input type="checkbox" name="chk" id="chk1-1"><label for="chk1-1">진행중</label></div>
        </div>
        <div class="bn">
      ...
      <div class="mytask-list_regist flex jc-sb as mg-t20">
      ...
      <div class="scroll_pd">
        <ul class="mytask-list_wrap">
          <li v-for="(item, index) in mysList" :key="index">
            <div>
