          ...
          <li class="item sortable-ghost" :class="element.class">
            ...
            <div class="group-view_list_inner">
              <div class="group-view_list_head">
                <div class="flag-check_wrap">
                  <span class="flag-check">
                    <input type="checkbox" :id="element.listId" :checked="element.checked" :disabled="element.disabled"><label :for="element.listId">중점</label>
                  </span>
                  <span class="flag-icon state01" :class="element.flagClass"></span>
                </div>
