	...
	<div>
        ...
        <div class="dropdown-collab-type1 icon lg" id="select-box2">
          ...
          >
			...
			<div class="header-btn tutorial-wrap">
        <button type="button" class="btn bk plus">새 협업보드 만들기</button>
        <div class="tooltip-b cr tutorial" v-if="tutorialClose">
          <ul class="list-dot">
            <li>여러 팀원과 협업할 수 있는 보드를 생성해 보세요</li>
          </ul>
